...
let CohortView = function(){
  ...
  function init()
  {
    ...
    //let url = 'https://uic-evl.github.io/CAMP-RT/?id='+patients[selectedID]["Dummy ID"];

    cohort.append("div")
          .append("label")
          .text("Affected Lymph Nodes: ")
          .append("button")
          .attr("onclick","window.location='https://uic-evl.github.io/CAMP-RT/?id="+patients[selectedID]["Dummy ID"]+"';")
          .text("CAMP-RT");
    ...
    cohort.append("div")
          ...
          .text("Lymph Clusters : ")
          .append("button")
          .attr("onclick","window.location='https://uic-evl.github.io/LymphaticCancerViz/?id="+patients[selectedID]["Dummy ID"]+"';")
          .text("Lymph Clusters");
    ...
    cohort.append("div")
          ...
          .text("Dendrogram : ")
          .append("button")
          .attr("onclick","window.location='http://uic-evl.github.io/LymphaticCancerViz/dendrogram/?id="+patients[selectedID]["Dummy ID"]+"';")
          .text("Lymph Clusters");
